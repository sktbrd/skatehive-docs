...
![Alt ​​text](@site/src/assets/Tuto-Dev/1.png)
...
![Alt ​​text](@site/src/assets/Tuto-Dev/2.png)

Isso criará sua própria versão do repositório em sua conta:

![Alt ​​text](@site/src/assets/Tuto-Dev/3.png)
...
![Alt ​​text](@site/src/assets/Tuto-Dev/4.png)
...
![Alt ​​text](@site/src/assets/Tuto-Dev/5.png)
Espere um pouco, tome um "café"...

Você deverá ver isso quando acabar:
![Alt ​​text](@site/src/assets/Tuto-Dev/6.png)
...
![Alt ​​text](@site/src/assets/Tuto-Dev/9.png)
...
![Alt ​​text](@site/src/assets/Tuto-Dev/10.png)

2.Instale a extensão Github 
3. Selecione o repositório
![Alt ​​text](@site/src/assets/Tuto-Dev/11.png)

4. Clique em Deploy

Você deverá ver algo assim:

![Alt ​​text](@site/src/assets/Tuto-Dev/12.png)
